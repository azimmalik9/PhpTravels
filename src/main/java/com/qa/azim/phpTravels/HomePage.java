...
public class HomePage extends PageObject{
	...
	public void checkIn() {
		...
		WebElement date = driver.findElement(By.xpath("/html/body/div[9]/div[1]/table/tbody/tr[5]/td[4]"));
	...
	public void checkOut() {
		...
		// used to get second week, Friday
		WebElement date = driver.findElement(By.xpath("/html/body/div[10]/div[1]/table/tbody/tr[5]/td[7]"));
	...
	public void selectNumPeople() {
		...
		// used to add additional adult, because first value in list is 2
